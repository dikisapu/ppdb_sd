...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
        ...
        <div class="container mb-3">
          <div class="d-flex align-items-center">
            <div class="site-logo mr-auto">
              <a href="index.html">SD Al-Azhar<span class="text-primary">.</span></a>
            </div>
    ...
    <div class="ftco-blocks-cover-1">
      ...
      <div class="site-section-cover overlay" data-stellar-background-ratio="0.5" style="background-image: url('../../assets/style/images/hero_12.jpg')">
        <div class="container">
          <div class="row align-items-center ">
            ...
            <div class="col-md-5 mt-5 pt-5">
              ...
              <p>SD AL-AZHAR BANDAR LAMPUNG</p>
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
            ...
            <h2 class="text-black">SD AL-Azhar Galery</h2>
          </div>
        </div>
        <div class="row">
          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/img_1.jpg" data-fancybox="gal"><img src="../../assets/style/images/1.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/img_2.jpg" data-fancybox="gal"><img src="../../assets/style/images/2.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/img_3.jpg" data-fancybox="gal"><img src="../../assets/style/images/3.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/img_4.jpg" data-fancybox="gal"><img src="../../assets/style/images/4.jpg" alt="Image" class="img-fluid"></a>
          </div>

          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/img_5.jpg" data-fancybox="gal"><img src="../../assets/style/images/5.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/img_2.jpg" data-fancybox="gal"><img src="../../assets/style/images/6.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/img_2.jpg" data-fancybox="gal"><img src="../../assets/style/images/7.jpg" alt="Image" class="img-fluid"></a>
          </div>
          <div class="col-md-3 mb-4">
            <a href="../../assets/style/images/img_1.jpg" data-fancybox="gal"><img src="../../assets/style/images/9.jpg" alt="Image" class="img-fluid"></a> 
          </div>
        </div>
      </div>
    </div>
    ...
    <footer class="site-footer" style="padding: 20px 0 5px 0">
      <div class="container">
        <p class="text-center"> Developer : <a href="#" target="blank">Codesan</a> </p>
        <br><center><p>Repost by <a href='#' title='StokCoding.com' target='_blank'>Authorsan</a></p></center>
